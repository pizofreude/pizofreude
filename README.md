...
- 💞️ I’m looking to collaborate on projects related to: CAE Engineering, PowerBI, Python (Django, NumPy, SciPy, Pandas, Matplotlib), HTML5, CSS3, JavaScript, Java (limited to CAE), C++ (limited to OpenFOAM), MySQL, FreeCAD, Autodesk Fusion 360, CATIA v5, ANSYS WB, MATLAB, FluidSIM, MEDINA, PERMAS, OpenFOAM and MS Office packages.
